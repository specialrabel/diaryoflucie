...
void timeManager::update(float lock)
{
	...
	//시작시간 기록이 되었다면, 기록시간은 시작시간 이후부터 측정.
	if (_startRecord)
	{
		_recordTime = _timer->getWorldTime() - _startTime;
	}
}
...
void timeManager::start_record()
{
	_startRecord = true;

	_startTime = _timer->getWorldTime();
}
